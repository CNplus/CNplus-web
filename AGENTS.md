...
- 纯白背景，科技蓝与玉石绿作为强调色；官方 Logo 自带的红蓝笔触保持原样。
- 首屏要大胆、有吸引力，让第一次看到 CNplus 的人产生尝试欲；但不伪造指标或采用情况。
- 中文宋体可用于品牌主张，现代无衬线用于正文，等宽字体用于代码，体现中西结合。
- 不用紫色科技渐变、玻璃拟态、虚构指标、图库照片、emoji 图标墙。
- 不用等权三列功能卡代替内容层级。
